...
class Configurable extends \Magento\Catalog\Block\Product\View\AbstractView
{
    ...
    public function afterGetJsonConfig()
    {
        ...
        $getIdProduct = $currentProduct->getId();
       /* echo "<pre>";
        print_r($currentProduct->getId());
        die();*/
        ...
        $_product = $objectManager->get('Magento\Catalog\Model\Product')->load($getIdProduct);
        /*echo "<pre>";
        print_r($getIdProduct);
        die();*/
        $getAttributeConf = $_product->getData('editor_data');
        $config = [
            'getattribute'=> $getAttributeConf,
